...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.b2addb91.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.43c7ce97.mjs').then(interopDefault),
